    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function (process) {
        ...
        function bindModule(module) {
          ...
          if (Webflow.env()) {
            ...
            isFunction(module.preview) &&
              $win.on('__wf_preview', module.preview);
          }
        ...
        function unbindModule(module) {
          ...
          isFunction(module.preview) &&
            $win.off('__wf_preview', module.preview);
          isFunction(module.destroy) &&
            $win.off('__wf_destroy', module.destroy);
        ...
        if (Webflow.app) {
          ...
          Webflow.location = function (url) {
            window.dispatchEvent(
              new CustomEvent('__wf_location', { detail: url })
            );
          };
        }
        ...
        var k = (function (a, b, c) {
          ...
          E = function (a) {
            ...
            for (b = 0; b < C.length; b++)
              if (((c = C[b] + d), c in B.style))
                return { dom: c, css: D[b] + a };
          },
          F = (b.support = {
        ...
        var I = (b.frame = (function () {
          ...
          K = k(function (b) {
              ...
              if (a) {
                ...
                if ('object' == e) {
                  ...
                  t.call(
                    ...
                    s.call(this),
                    f > 0 &&
                      ((this.timer = new R({ duration: f, context: this })),
                      (this.active = !0),
            ...
            function k(a) {
              ...
              'string' == typeof a
                ? ((b = {}), (b[a] = 1))
                : (b = 'object' == typeof a && null != a ? a : this.props),
                t.call(this, b, u),
                s.call(this);
            }
            function l(a) {
            ...
            function s() {
              ...
              (c = c.join(',')),
                this.style !== c &&
                  ((this.style = c), (this.el.style[F.transition.dom] = c));
            }
            function t(a, b, e) {
              var f,
                g,
            ...
            (b.init = function (b) {
              ...
              F.backface &&
                T.hideBackface &&
                U(this.el, F.backface.css, 'hidden');
            }),
              x('add', d),
              x('start', e),
              x('wait', f),
          ...
          M = k(function (a) {
            ...
            (a.init = function (a, b, d, e) {
              ...
              d[2] && (g = d[2]),
                ...
                (this.unit = e.unit || this.unit || T.defaultUnit),
                (this.angle = e.angle || this.angle || T.defaultAngle),
            ...
            (a.init = function () {
              b.init.apply(this, arguments),
                this.current ||
                  ...
                  Y.perspective &&
                    T.perspective &&
                    ((this.current.perspective = T.perspective),
        ...
        (module.exports = function ($, _) {
          ...
          api.ready = function () {
            ...
            if (doBranding) {
              ...
              $webflowLogo.attr(
                'src',
                'https://daks2k3a4ib2z.cloudfront.net/54153e6a3d25f2755b1f14ed/5445a4b1944ecdaa4df86d3e_subdomain-brand.svg'
              );
              $webflowLogo.css({
                opacity: 0.9,
                width: '57px',
          ...
          function getStatus(field, type, name, value) {
            ...
            if (type === 'password') {
              ...
              if (!value) {
                ...
                emailField.test(name) ||
                emailField.test(field.attr('type'))
              ) {
	...
	*/
          ...
          loadImage(url, function ($image) {
            ...
            function transitionToNewView() {
              ...
              if ($refs.items) {
                ...
                addClass(
                  removeClass($refs.items, 'active').eq(index),
                  'active'
                );
              }
            }
        ...
        (module.exports = function ($, _) {
          ...
          function select(link) {
            ...
            if (href.indexOf('#') === 0 && validHash.test(href)) {
              var $section = $(href);
              $section.length &&
                anchors.push({ link: $link, sec: $section, active: false });
              return;
            }
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _) {
          ...
          function getState(el, data) {
            ...
            var mapDraggable =
              Webflow.env.touch && data.disableTouch ? false : true;
    ...
    /***/ function (module, exports) {
      ...
      module.exports = (function ($) {
        ...
        $.ajaxTransport('* text html xml json', function (
          options,
          userOptions,
          jqXHR
        ) {
...
Webflow.require('ix').init([
  {
    slug: 'close-contact-overlay',
    name: 'Close Contact Overlay',
    value: {
      style: {},
      triggers: [
        {
  ...
  {
    slug: 'show-contact-overlay',
    name: 'Show Contact Overlay',
    value: {
      style: {},
      triggers: [
        {
  ...
  },
  {
    ...
    name: 'Tile 1',
    value: {
      style: { opacity: 0, scaleX: 0.96, scaleY: 0.96, scaleZ: 1 },
      triggers: [
        {
          type: 'load',
          stepsA: [
